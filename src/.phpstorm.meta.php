...
'view.compiled','image.default','cors.paths','cors.allowed_methods','cors.allowed_origins',
...
'signed','throttle','verified','admin',);
        registerArgumentsSet('routes', 'pessoas.index','profile.edit','profile.update',
'profile.destroy','pessoas.create','pessoas.store','pessoas.show','pessoas.edit',
'pessoas.update','pessoas.destroy','pessoas.telefones.store','telefones.edit','telefones.update',
'telefones.destroy','gerenciar-pessoas','gerenciar-pessoas.salvar','register',
...
'admin.gerenciar-pessoas','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','components.alert','components.application-logo','components.auth-session-status',
'components.danger-button','components.dropdown','components.dropdown-link','components.forms.pessoa-form','components.input-error',
'components.input-label','components.link-button','components.modal','components.nav-link','components.page-layout',
'components.page-shell','components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input',
'layouts.app','layouts.guest','layouts.navigation','pessoas.create','pessoas.edit',
'pessoas.index','pessoas.show','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','telefones.edit','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
